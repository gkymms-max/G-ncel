...
function createWindow() {
  ...
  const setupSession = (sessionName) => {
    ...
    // Set user agent for the session - Use actual Chromium version (120.x for Electron 28)
    // WhatsApp detects version mismatches, so must match actual Chromium build
