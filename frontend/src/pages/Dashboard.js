...
import { LogOut, Package, FileText, Settings, FolderOpen, Users, MessageCircle, UserCheck, TrendingUp, Calendar } from "lucide-react";
...
export default function Dashboard({ setIsAuthenticated }) {
  ...
  const userMenuItems = [
    ...
    { path: "/social-media-planner", icon: Calendar, label: "Sosyal Medya Planlama" },
